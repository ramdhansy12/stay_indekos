...
import 'package:stay_indekos/source/user_source.dart';
import 'package:stay_indekos/widget/button_custom2.dart';
...
class SigninPage extends StatelessWidget {
  ...
  //   if (formKey.currentState!.validate()) {
  //     UserRegister.(controllerEmail.text, controllerPassword.text)
  //         .then((response) {
  //       if (response['success']) {
  //         DInfo.dialogSuccess(response['message']);
  //         DInfo.closeDialog(actionAfterClose: () {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ButtonCustom2(
                        label: 'Sign Up',
                        onTap: () {
                          Navigator.popAndPushNamed(context, AppRoute.signup);
                        },
                        isExpand: true,
                      ),
                      // const Text(
